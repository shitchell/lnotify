...
COMMON_SRC = src/log.c src/notification.c src/protocol.c src/config.c src/engine.c src/resolver.c
DAEMON_SRC = src/daemon/main.c $(COMMON_SRC)
CLIENT_SRC = src/client/main.c $(COMMON_SRC)
TEST_SRC   = tests/test_main.c tests/test_notification.c tests/test_protocol.c tests/test_config.c tests/test_resolver.c $(COMMON_SRC)

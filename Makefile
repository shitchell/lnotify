...
COMMON_SRC = src/log.c src/notification.c src/protocol.c src/config.c src/engine.c src/resolver.c src/logind.c src/queue.c src/render_util.c src/font_bitmap.c src/engine_fb.c src/engine_dbus.c src/engine_queue.c src/engine_terminal.c
